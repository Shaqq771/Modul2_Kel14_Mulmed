...
import com.example.modul2_kel14.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (FirstTime.equals("No")) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intro = new Intent(SplashScreenActivity.this, com.example.modul2_kel14.MainActivity.class);
                    startActivity(intro);
                    finish();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    editor.apply();
                    Intent login = new Intent(SplashScreenActivity.this, com.example.modul2_kel14.LandingPageActivity.class);
                    startActivity(login);
                    finish();
                    overridePendingTransition(0, 0);
                    getIntent().addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
